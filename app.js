class Media {
  ...
  getAverageRating() {
    let arrSum = this.ratings.reduce(
...
console.log(
  "The average rating for the History of Everything book is " +
    historyOfEverything.getAverageRating()
);
...
console.log(
  "The average rating for the speed movie is " + speed.getAverageRating()
);
